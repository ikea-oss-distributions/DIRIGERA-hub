...
In the U-Boot source directory (sources/*/u-boot-stm32mp-v2020.10-stm32mp-r2-r0),
...
4.1 Get STMicroelectronics U-Boot source from GitHub
    ...
    Branch: v2020.10-stm32mp
    Revision: v2020.10-stm32mp-r2

    $ git clone https://github.com/STMicroelectronics/u-boot.git
    $ git checkout -b WORKING v2020.10-stm32mp-r2
...
or
    ...
    $ cd u-boot
    $ git checkout -b WORKING v2020.10
    $ for p in `ls -1 ../*.patch`; do git am $p; done
